...
amd-amf, aom, bzip2, dav1d, fdk-aac, ffnvcodec, fontconfig, freetype, fribidi, harfbuzz, lensfun, libass, libbluray, libgme, libiconv, libilbc, libjxl, liblzma, libmodplug, libmysofa, libopenmpt, libsrt, libssh, libtheora, libvorbis, libvpl, libvpx, libwebp, libxml2, mfx-dispatch, mp3lame, opencl, opengl, openh264, openjpeg, openssl, opus, sdl2, shaderc, snappy, soxr, speex, svt-av1, tesseract, x264, x265, zeromq, zlib
