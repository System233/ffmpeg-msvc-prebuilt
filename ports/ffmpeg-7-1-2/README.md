...
| d3d12va | `--enable-d3d12va` | Direct3D 12 Video Acceleration |  |
...
| harfbuzz | `--enable-libharfbuzz` | Enable drawtext filter | !uwp |
...
amd-amf, aom, bzip2, dav1d, fdk-aac, ffnvcodec, fontconfig, freetype, fribidi, harfbuzz, lensfun, libass, libbluray, libdvdnav, libdvdread, libgme, libiconv, libilbc, libjxl, liblzma, libmodplug, libmysofa, libopenmpt, libsrt, libssh, libtheora, libvorbis, libvpl, libvpx, libwebp, libxml2, mfx-dispatch, mp3lame, opencl, opengl, openh264, openjpeg, openssl, opus, sdl2, shaderc, snappy, soxr, speex, svt-av1, tesseract, vulkan, vvenc, x264, x265, zeromq, zlib
