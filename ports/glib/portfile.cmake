...
if(VCPKG_TARGET_IS_WINDOWS AND VCPKG_LIBRARY_LINKAGE STREQUAL "static")
    vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/lib/pkgconfig/glib-2.0.pc" "-lws2_32 -lwinmm" "-lws2_32 -lwinmm -lole32 -lshlwapi -luuid -ladvapi32 -lshell32 -luser32")
    if(NOT VCPKG_BUILD_TYPE)
        vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/glib-2.0.pc" "-lws2_32 -lwinmm" "-lws2_32 -lwinmm -lole32 -lshlwapi -luuid -ladvapi32 -lshell32 -luser32")
    endif()
endif()
