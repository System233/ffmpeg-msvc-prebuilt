...
if(VCPKG_LIBRARY_LINKAGE STREQUAL "static")
    vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/lib/pkgconfig/lensfun.pc" "Cflags:" "Cflags: -DCONF_LENSFUN_STATIC")
    if(NOT VCPKG_BUILD_TYPE)
        vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/lensfun.pc" "Cflags:" "Cflags: -DCONF_LENSFUN_STATIC")
    endif()
    vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/lib/pkgconfig/lensfun.pc" "-llensfun" "-llensfun -ltre_regex")
    if(NOT VCPKG_BUILD_TYPE)
        vcpkg_replace_string("${CURRENT_PACKAGES_DIR}/debug/lib/pkgconfig/lensfun.pc" "-llensfun" "-llensfun -ltre_regex")
    endif()
endif()
