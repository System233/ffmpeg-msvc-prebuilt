...
| YAML | extends | Chain |
|------|---------|-------|
| `master.yaml` | `8.1` | `base → 8.0 → 8.1 → master` |
| `8.1.1.yaml` | `8.1` | `base → 8.0 → 8.1 → 8.1.1` |
| `8.1.yaml` | `8.0` | `base → 8.0 → 8.1` |
| `8.0.1.yaml` | `8.0` | `base → 8.0 → 8.0.1` |
| `8.0.yaml` | `base` | `base → 8.0` |
| `7.1.2.yaml` | `7.1` | `base → 7.0 → 7.1 → 7.1.2` |
| `7.1.1.yaml` | `7.1` | `base → 7.0 → 7.1 → 7.1.1` |
| `7.1.yaml` | `7.0` | `base → 7.0 → 7.1` |
